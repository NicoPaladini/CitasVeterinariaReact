...
class AgregarCita extends Component{
    ...
    //Esto se conoce como object literal enhacement
    //En vez de escribir mascota: mascota, propietario: propietario
    //Lo que hace es utilizar directamente el nombre de la constante
    // Luego agregamos el id con la funcion uuid().
        const nuevaCita = {
                            id: uuid(),
                            mascota,
                            propietario,
        ...
        //Seteamos el state a false para eliminar el error
